...
###############################################################################################################################################
#
# Grabs the required ThumbPrint to be removed if present from JAMF variable #4 eg. bbbbaaaa360013f8
# If One is not Specified, then the script will search and remove any discovered instances.
#
PUBLIC_THUMBPRINT_PROCESS="$4"
#
# Set the name of the script for later logging
ScriptName="append prefix here as needed - ScreenConnect Cleanup"
#
###############################################################################################################################################
#
# Defining Functions
